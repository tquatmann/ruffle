# Dockerfile for ruffle
########################
# The Docker image can be built by executing:
# docker build -t yourusername/ruffle .
...
# Build ruffle
##############
RUN mkdir /opt/ruffle
WORKDIR /opt/ruffle

# Copy the content of the current local ruffle repository into the Docker image
COPY . .

# Switch to build directory
RUN mkdir -p /opt/ruffle/build
WORKDIR /opt/ruffle/build

# Configure ruffle using the (non-installed) version of storm.
